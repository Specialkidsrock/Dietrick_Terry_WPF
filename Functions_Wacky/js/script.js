...
if(yearsIn == 0 || yearsIn == ""){
    yearsIn = prompt("How many years have you been in the Army?", 10);

}else if(yearsLeft == 0 || yearsLeft == ""){
    yearsLeft = prompt("How many years do you think you have left before you decide to get out?", 2);

}else if(dayOfYear == 0 || dayOfYear == ""){
    dayOfYear = prompt("What day of the year is it? (1-365)",353);
